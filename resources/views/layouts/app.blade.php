                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="account-dropdown">
                                    ...
                                    {{-- Password --}}
                                    <a href="{{ route('profile.pass', Auth::user()->id) }}" class="dropdown-item">
                                        <i class="fa-brands fa-paypal"></i> Password
                                    </a>
                                    {{-- Logout --}}
                        ...
                        <div class="col-3">
                            <div class="list-group">
                                <a href="{{ route('admin.users') }}" class="list-group-item {{ request()->is('admin/users') ? 'active' : '' }}">
                                    <i class="fa-solid fa-users"></i> Users {{ Auth::user()->countUsers() }}
                                </a>
                                <a href="{{ route('admin.posts') }}" class="list-group-item {{ request()->is('admin/posts') ? 'active' : '' }}" >
                                    <i class="fa-solid fa-newspaper"></i> Posts {{ Auth::user()->countPosts() }}
                                </a>
                                <a href="{{ route('admin.categories') }}" class="list-group-item {{ request()->is('admin/categories') ? 'active' : '' }}">
                                    <i class="fa-solid fa-tags"></i> Categories {{ Auth::user()->countCategories() }}
                                </a>
                            </div>
                        </div>
                    @endif
